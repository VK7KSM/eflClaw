...
pub fn all_tools_with_runtime(
    ...
    tool_arcs.push(Arc::new(GetCurrentTimeTool));

    // elfClaw: chat log search tool (owner-gated)
    ...
    // elfClaw: send_email tool when email channel is configured
    ...
    // elfClaw: send_telegram + send_voice tools when telegram is configured
